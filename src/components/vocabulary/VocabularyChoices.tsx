...
import type { VocabularyChoice } from '../../learning/vocabularyTypes'

interface VocabularyChoicesProps {
...
export function VocabularyChoices({
  ...
  return (
    <fieldset className="choice-fieldset">
      <legend>Choose the English meaning</legend>
      <div className="choice-grid">
        {choices.map((choice, index) => {
          const isCorrect = revealed && choice.wordId === correctWordId
          const isIncorrect =
            revealed &&
            choice.wordId === selectedChoiceId &&
            choice.wordId !== correctWordId
          ...
          return (
            <button
              ...
              type="button"
              key={choice.wordId}
              onClick={() => onChoose(choice.wordId)}
              disabled={revealed}
